...
======================================================================================
Script Purpose:
    This stored procedure perdorms the ETL (Extract, Transfer, Load) process to
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CAST(
                ...
                AS DATE
            ) AS prd_end_dt -- Calculate end date as one day before start date
        ...
        SELECT
            ...
            CASE
                ...
                ELSE 'N/A'
            END AS gen -- Normalize gender into readable format and handle unknown cases
